    ...
    <GlassCard className="p-5 space-y-4">
      ...
      <div className="overflow-x-auto">
        <table className="w-full text-left font-mono text-xs border-collapse">
          <thead>
            <tr className="border-b border-[var(--border)] bg-[#0f172a]/60 text-slate-400 uppercase text-[10px] tracking-wider">
                ...
                >
                  ...
                  <td className="py-3 px-3 text-slate-400 text-[11px] max-w-[240px]">
                    {cp.keterangan === "-" ? (
                      ...
                      <div className="flex items-start gap-1 text-amber-300/90 bg-amber-500/10 p-1.5 rounded border border-amber-500/20 text-[10px]">
                        <Info className="w-3.5 h-3.5 shrink-0 text-amber-400 mt-0.5" />
                        <span>{cp.keterangan}</span>
                      </div>
                    )}
                  </td>
