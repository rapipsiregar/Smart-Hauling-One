...
async function run() {
  ...
  for (const item of items) {
    ...
    await page.goto(`${BASE_URL}${item.route}`, { waitUntil: 'networkidle2' });
  ...
  await page.goto(`${BASE_URL}/crossing`, { waitUntil: 'networkidle2' });
  await ensureDarkMode();
  await ensureGuideModeOff();
  ...
  await page.goto(`${BASE_URL}/cctv-history`, { waitUntil: 'networkidle2' });
  await ensureDarkMode();
  await ensureGuideModeOff();
  await new Promise(r => setTimeout(r, 500));
  await page.evaluate(() => {
  ...
  await page.goto(`${BASE_URL}/fleet`, { waitUntil: 'networkidle2' });
  await ensureDarkMode();
  await ensureGuideModeOff();
  await new Promise(r => setTimeout(r, 500));
  await page.evaluate(() => {
